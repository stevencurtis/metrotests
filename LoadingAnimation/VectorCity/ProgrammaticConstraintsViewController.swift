...
final class ProgrammaticConstraintsViewController: UIViewController {
    
    private var tree0 = UIImageView()
    private let city = UIImageView()
    private let city2 = UIImageView()
    private let manImage = UIImageView()
